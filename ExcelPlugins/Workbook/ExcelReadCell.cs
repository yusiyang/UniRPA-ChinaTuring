...
namespace ExcelPlugins
{
    ...
    [Designer(typeof(ExcelReadCellDesigner))]
    public sealed class ExcelReadCell : AsyncCodeActivity
    {
        #region 属性分类：常见
        ...
        [RequiredArgument]
        [DisplayName("单元格内容")]
        public OutArgument<string> CellContent { get; set; }
        ...
        [Browsable(false)]
        public string icoPath { get { return "pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/excel/getcell.png"; } }

        [Browsable(false)]
        public string ClassName { get { return "ExcelReadCell"; } }

        #endregion


        public ExcelReadCell()
        {
            //填写默认值
            //SheetIndex = 1;
            SheetName = "Sheet1";
        ...
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
        {
            ...
            try
            {
                ...
                string cellContent = sheet.Range[cellAddress].Text;
