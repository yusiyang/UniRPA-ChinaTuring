...
namespace ExcelPlugins
{
    ...
    [Designer(typeof(ExcelReadRangeDesigner))]
    public sealed class ExcelReadRange : AsyncCodeActivity
    {
        #region 属性分类：常见
        ...
        [Browsable(false)]
        public string ClassName { get { return "ExcelReadRange"; } }

        #endregion


        public ExcelReadRange()
        {
            //填写默认值
            //SheetIndex = 1;
            SheetName = "Sheet1";
