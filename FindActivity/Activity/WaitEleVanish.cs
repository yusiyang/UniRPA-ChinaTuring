...
namespace FindActivity
{
    ...
    public sealed class WaitEleVanish : CodeActivity
    {
        #region 属性分类：常见
        ...
        [Category("选项")]
        [DisplayName("等待元素未激活")]
        [Description("选中该复选框时，该活动只等待至指定用户界面元素不再处于活动状态。")]
        public bool WaitNotActivity { get; set; }

        [Category("选项")]
        [DisplayName("等待元素不可见")]
        [Description("选中该复选框时，该活动只等待至用户界面元素从屏幕上消失，即使其仍处于活动状态。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Find/EleVanish.png";
            }
        }
        ...
        [Browsable(false)]
        public string DefaultName { get { return "等待元素消失"; } }
