...
namespace FindActivity
{
    ...
    public sealed class IndicateScreen : CodeActivity
    {
        ...
        [Category("选项")]
        [DisplayName("隐藏预览")]
        [Description("选择用户界面元素时，隐藏预览窗口。")]
        public bool HidePreview { get; set; }

        [Category("选项")]
        [DisplayName("选择屏幕区域")]
        [Description("选中该复选框时，可在屏幕上选择区域。")]
        ...
        [Category("输出")]
        [DisplayName("选定的用户界面元素")]
        [Description("选定的用户界面元素。仅支持用户界面元素变量。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Find/IndicateScreen.png";
            }
        }
