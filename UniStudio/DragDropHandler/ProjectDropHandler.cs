...
namespace UniStudio.DragDropHandler
{
    public class ProjectDropHandler : DefaultDropHandler
    {
        ...
        private bool MoveDirToDir(ProjectTreeItem sourceItem, ProjectTreeItem targetItem)
        {
            ...
            {
                UniMessageBox.Show(App.Current.MainWindow, "目标目录有重名目录，无法移动目录", "警告", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
            else
            {
        ...
        private bool MoveFileToDir(ProjectTreeItem sourceItem, ProjectTreeItem targetItem)
        {
            ...
            {
                UniMessageBox.Show(App.Current.MainWindow, "目标目录有重名文件，无法移动文件", "警告", MessageBoxButton.OK, MessageBoxImage.Warning);
            }
            else
            {
