            ...
            get
            {
                return _openProjectCommand
                    ...
                    () =>
                    {
                        ...
                        {
                            //不存在则提示用户移除条目
                            var ret = UniMessageBox.Show(App.Current.MainWindow, string.Format("无法打开项目配置文件\"{0}\"，是否从最近项目列表中移除该条目？", ProjectFilePath), "询问", MessageBoxButton.OKCancel, MessageBoxImage.Question, MessageBoxResult.Cancel);
