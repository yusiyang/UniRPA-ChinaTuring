...
namespace UniStudio.ViewModel
{
    ...
    public class OutputViewModel : ViewModelBase
    {
        ...
        #region 全局主题配色
        public const string ToolWindowsBorderBackgroundPropertyName = "ToolWindowsBorderBackground";
        private SolidColorBrush _toolWindowsBorderBackground = new BrushConverter().ConvertFrom("#ffffff") as SolidColorBrush;
        public SolidColorBrush ToolWindowsBorderBackground
        {
            get
            {
                return _toolWindowsBorderBackground;
            }
            set
            {
                if (_toolWindowsBorderBackground == value)
                {
                    return;
                }

                _toolWindowsBorderBackground = value;
                RaisePropertyChanged(ToolWindowsBorderBackgroundPropertyName);
            }
        }

        public const string OptionsSelectedBackgroundPropertyName = "OptionsSelectedBackground";
        private SolidColorBrush _optionsSelectedBackground = new BrushConverter().ConvertFrom("#c2c2c2") as SolidColorBrush;
        public SolidColorBrush OptionsSelectedBackground
        {
            get
            {
                return _optionsSelectedBackground;
            }
            set
            {
                if (_optionsSelectedBackground == value)
                {
                    return;
                }

                _optionsSelectedBackground = value;
                RaisePropertyChanged(OptionsSelectedBackgroundPropertyName);
            }
        }

        public const string OptionsTextForegroundPropertyName = "OptionsTextForeground";
        private SolidColorBrush _optionsTextForeground = new BrushConverter().ConvertFrom("#000000") as SolidColorBrush;
        public SolidColorBrush OptionsTextForeground
        {
            get
            {
                return _optionsTextForeground;
            }
            set
            {
                if (_optionsTextForeground == value)
                {
                    return;
                }

                _optionsTextForeground = value;
                RaisePropertyChanged(OptionsTextForegroundPropertyName);
            }
        }
        ...
        public const string SearchTextBoxBackgroundPropertyName = "SearchTextBoxBackground";
        private SolidColorBrush _searchTextBoxBackground = new BrushConverter().ConvertFrom("#ffffff") as SolidColorBrush;
        public SolidColorBrush SearchTextBoxBackground
        {
            get
            {
            ...
            set
            {
                ...
                RaisePropertyChanged(SearchTextBoxBackgroundPropertyName);
            }
        }
        #endregion
        ...
        public void Log(SharedObject.OutputType type, string msg, string msgDetails)
        {
            ...
            switch (type)
            {
                case SharedObject.OutputType.Error:
                    item.IsError = true;
                    ErrorCount++;
                    if (isDarkTheme)
                    {
                        item.TextForeground = "#f2697b";
                    }
                    else
                    {
                        item.TextForeground = "#e01530";
                    }
                    break;
                case SharedObject.OutputType.Warning:
                    item.IsWarning = true;
                    WarningCount++;
                    if (isDarkTheme)
                    {
                        item.TextForeground = "#ff8c00";
                    }
                    else
                    {
                        item.TextForeground = "#ff8c00";
                    ...
                    break;
                case SharedObject.OutputType.Information:
                    item.IsInformation = true;
                    InformationCount++;
                    if (isDarkTheme)
                    {
                        item.TextForeground = "#e6e6e6";
                    }
                    else
                    {
                        item.TextForeground = "#000000";
                    }
                    break;
                case SharedObject.OutputType.Trace:
                    item.IsTrace = true;
                    TraceCount++;
                    if (isDarkTheme)
                    {
                        item.TextForeground = "#676768";
                    }
                    else
                    {
