...
namespace UniStudio.ViewModel
{
    public class PackageSourceSearchResultItem : ViewModelBase
    {
        ...
        public PackageSourceSearchResultItem(PackageManagerViewModel vm, PackageIdentity identity, string id, string authors, string description, string icon_url = "")
        {
            this.m_vm = vm;
        ...
        /// <summary>
        /// The <see cref="PackageStatus" /> property's name.
        /// </summary>
        public const string PackageStatusPropertyName = "PackageStatus";

        private BitmapImage _packageStatusProperty = null;

        /// <summary>
        /// Sets and gets the IsInstalled property.
        /// Changes to that property's value raise the PropertyChanged event. 
        /// </summary>
        public BitmapImage PackageStatus
        {
            get
            {
                return _packageStatusProperty;
            }

            set
            {
                if (_packageStatusProperty == value)
                {
                    return;
                }

                _packageStatusProperty = value;
                RaisePropertyChanged(PackageStatusPropertyName);
            }
        }
