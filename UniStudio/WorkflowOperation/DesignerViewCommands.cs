...
namespace UniStudio.WorkflowOperation
{
    public class DesignerViewCommands
    {
        ...
        public static readonly ICommand OpenWorkflowCommand = new RoutedCommand(OpenWorkflowCommandName, typeof(DesignerViewWrapper));
    }
}
