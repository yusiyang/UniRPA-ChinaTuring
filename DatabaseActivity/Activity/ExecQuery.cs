...
namespace DatabaseActivity
{
    ...
    public sealed class ExecQuery : AsyncCodeActivity
    {
        ...
        [RequiredArgument]
        [DisplayName("SQL")]
        [Description("执行的 SQL 命令语句。必须将文本放入引号中。")]
        ...
        [Category("输出")]
        [DisplayName("数据表")]
        [Description("将 SQL 查询的输出存储在 DataTable 变量中。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/DataBase/query.png";
            }
        }
