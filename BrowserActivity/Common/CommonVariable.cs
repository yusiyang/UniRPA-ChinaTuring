...
namespace BrowserActivity
{
    ...
    public class Browser
    {
        ...
        private IntPtr NativeHostIntPtr;
        ...
        public void SetChrome(IntPtr intPtr)
        {
            this.NativeHostIntPtr = intPtr;
        }
        ...
        public IntPtr GetCFBrowser()
        {
            //return NativeMessageManager.NativeHostIntPtr;
            return NativeHostIntPtr;
        }
    }
