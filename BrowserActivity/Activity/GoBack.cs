...
namespace BrowserActivity
{
    ...
    public sealed class GoBack : AsyncCodeActivity
    {
        #region 属性分类：常见
        ...
        [Category("输入")]
        [DisplayName("浏览器")]
        [Description("要前往的浏览器。该字段仅支持浏览器变量。")]
        ...
        [Browsable(false)]
        public string ClassName { get { return "GoBack"; } }
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Browser/GoBack.png";
            }
        }
