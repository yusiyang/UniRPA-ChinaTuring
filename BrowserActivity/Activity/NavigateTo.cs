...
namespace BrowserActivity
{
    ...
    public sealed class NavigateTo : AsyncCodeActivity
    {
        ...
        [Category("输入")]
        [DisplayName("浏览器")]
        [Description("要导航至指定页面的浏览器。该字段仅支持浏览器变量。")]
        public InArgument<IBrowser> currBrowser { get; set; }

        [Category("输入")]
        [RequiredArgument]
        [DisplayName("URL")]
        [Description("要导航至指定页面的URL。必须将文本放入引号中。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Browser/NavigateTo.png";
            }
        }
        ...
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
        {
            ...
            try
            {
                ...
                var browser = currBrowser.Get(context);
                //先走 其次走流程
                if (browser == null)
                {
