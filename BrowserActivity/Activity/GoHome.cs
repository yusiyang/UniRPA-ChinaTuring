...
{
    [Designer(typeof(GoHomeDesigner))]
    public sealed class GoHome : AsyncCodeActivity
    {
        #region 属性分类：常见
        ...
        [Category("输入")]
        [DisplayName("浏览器")]
        [Description("要转至起始页或主页的浏览器。该字段仅支持浏览器变量。")]
        ...
        [Browsable(false)]
        public string ClassName { get { return "GoHome"; } }
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Browser/GoHome.png";
            }
        }
