...
namespace UniWorkforce.Services
{
    public class RobotService
    {
        ...
        public async Task<PublishResponse> PublishProcessAsync(PublishRequest request)
        {
            return await client.PublishProcessAsync(request);
        }
        ...
        public GetRobotTypeResponse GetRobotTypeList()
        {
            var request = new GetRobotTypeRequest
            {
                SessionId = Context.Current.SessionId
            };

            return client.GetRobotTypeList(request);
        }
    }
}
