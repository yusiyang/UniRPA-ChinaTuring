...
namespace UniWorkforce.ViewModel
{
    ...
    public class StartupViewModel : ViewModelBase
    {
        ...
        private void Init()
        {
            ProgramVersion = string.Format("Uni Workforce - {0}", Common.GetProgramVersion());
                ...
                return _quitMainWindowCommand
                    ...
                    () =>
                    {
                        if(!IsQuitAsking)
                        {
                            ...
                            var ret = UniMessageBox.Show(App.Current.MainWindow, "确定退出吗？", "询问", MessageBoxButton.YesNo, MessageBoxImage.Question, MessageBoxResult.No);
