...
namespace AttributeActivity
{
    ...
    public sealed class GetAttr : CodeActivity
    {
        ...
        [RequiredArgument]
        [DisplayName("属性")]
        [Description("待检索的属性名称。必须将文本放入引号中。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Attribute/GetAttr.png";
            }
        }
        ...
        [Browsable(false)]
        public string DefaultName { get { return "获取属性"; } }
