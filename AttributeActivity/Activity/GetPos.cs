...
namespace AttributeActivity
{
    ...
    public sealed class GetPos : CodeActivity
    {
        ...
        [Category("输出")]
        [DisplayName("矩形")]
        [Description("屏幕坐标中生成的指定用户界面元素边框。仅支持矩形变量。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Attribute/GetPos.png";
            }
        }
        ...
        [Browsable(false)]
        public string DefaultName { get { return "获取坐标"; } }
