...
{
    public partial class BuildDataTableDialog : RibbonWindow, IComponentConnector
    {
        private DataSet _dataSet;

        private ModelItem _activityModel;

        internal BuildDataTableDialog BuildDataTableWnd;
        ...
        private void OkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception arg_46_0)
            {
                ...
                //this.ShowError(UiPath_System_Activities_Design.DataTableNotSavedExceptionMessage);
            }
        }

        private void ShowError(string message)
        {
            //UniMessageBox.Show(message, UiPath_System_Activities_Design.ErrorMessageBox_Title, MessageBoxButton.OK, MessageBoxImage.Hand);
        }
        ...
        private void TableDataGrid_ColumnReordered(object sender, DataGridColumnEventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(str) && (this.DataTable.Columns.IndexOf(str) != -1))
            {
                ...
                if (column == null)
                {
                    //this.ShowError(UiPath_System_Activities_Design.ColumnNotFoundError);
                }
                else
                {
