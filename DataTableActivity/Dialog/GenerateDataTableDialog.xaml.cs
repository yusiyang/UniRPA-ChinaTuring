...
namespace DataTableActivity.Dialog
{
    ...
    public partial class GenerateDataTableDialog : RibbonWindow
    {
        ...
        private void Format()
        {
            ...
            catch (Exception ex)
            {
                ...
                if (window != null)
                {
                    //UniMessageBox.Show(window, ex.Message, UiPath_System_Activities_Design.ErrorMessageBox_Title, MessageBoxButton.OK, MessageBoxImage.Hand);
                }
                else
                {
                    //UniMessageBox.Show(ex.Message, UiPath_System_Activities_Design.ErrorMessageBox_Title, MessageBoxButton.OK, MessageBoxImage.Hand);
                }
