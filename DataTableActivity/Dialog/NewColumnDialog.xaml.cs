...
namespace DataTableActivity.Dialog
{
    public partial class NewColumnDialog : RibbonWindow,  INotifyPropertyChanged, IComponentConnector
    {
        ...
        internal TypePresenter TypePresenter;
        ...
        private void OkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                UniMessageBox.Show(ex.Message, "Error", MessageBoxButton.OK, MessageBoxImage.Hand);
            }
        }
        ...
        //    Uri resourceLocator = new Uri("/UiPath.System.Activities.Design;component/designers/datatable/newcolumndialog.xaml", UriKind.Relative);
        ...
        //    {
        //        case 1:
        //            ((Button)target).Click += new RoutedEventHandler(this.CancelButton_Click);
        //            return;
        //        case 2:
        //            ((Button)target).Click += new RoutedEventHandler(this.OkButton_Click);
        //            return;
        //        case 3:
        //            this.TypePresenter = (TypePresenter)target;
        //            this.TypePresenter.PropertyChanged += new PropertyChangedEventHandler(this.TypePresenter_PropertyChanged);
        //            return;
        //        case 4:
        //            this.WarningImage = (Image)target;
        //            return;
        //        default:
        //            this._contentLoaded = true;
        //            return;
