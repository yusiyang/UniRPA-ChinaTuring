...
namespace DataTableActivity
{
    public partial class GenerateDataTableDesigner
    {
        ...
        private void GenerateDataTableButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                PreserveNewLines = this.TryGetBoolArgumentValue("PreserveNewLines"),
                CSVParsing = this.TryGetBoolArgumentValue("CSVParse"),
                PreserveStrings = this.TryGetBoolArgumentValue("PreserveStrings"),
            ...
            if ((nullable.GetValueOrDefault() == flag) ? nullable.HasValue : false)
            {
                ...
                base.ModelItem.Properties["CSVParse"].SetValue(dialog.FormatOptions.CSVParsing);
        ...
        private bool TryGetBoolArgumentValue(string propertyName)
        {
            return (bool) base.ModelItem.Properties[propertyName].ComputedValue;
        }
    }
}