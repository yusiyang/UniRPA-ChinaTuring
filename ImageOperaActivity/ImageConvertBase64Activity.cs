...
namespace ImageOperaActivity
{
    ...
    public sealed class ImageConvertBase64Activity : CodeActivity
    {
        ...
        [RequiredArgument]
        [DisplayName("文件名称")]
        [Description("要读取的图片文件文件的全路径。必须将文本放入引号中。")]
        ...
        [Category("输出")]
        [DisplayName("图片字符串内容")]
        [Description("转换图片得到的 Base64 字符串内容。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Image/base64.png";
            }
        }
