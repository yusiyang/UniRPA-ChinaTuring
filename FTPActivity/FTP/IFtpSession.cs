...
namespace FTPActivity
{
    ...
    public interface IFtpSession : IDisposable
    {
        ...
        void Download(string remotePath, string localPath, FtpLocalExists overwrite, bool recursive);
        Task DownloadAsync(string remotePath, string localPath, FtpLocalExists overwrite, bool recursive, CancellationToken cancellationToken);
