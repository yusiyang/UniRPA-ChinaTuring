...
namespace FTPActivity
{
    ...
    public class DirectoryExists : ContinuableAsyncCodeActivity
    {
        ...
        [RequiredArgument]
        [DisplayName("路径")]
        [Description("指定的文件夹路径。必须将文本放入引号中。")]
        ...
        {
            get { return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/FTP/exist-directory.png"; }
        }
