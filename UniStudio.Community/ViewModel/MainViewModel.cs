...
using UniStudio.Community.Executor.Services;
...
using DebuggerService = UniStudio.Community.Executor.Services.DebuggerService;
    ...
    public partial class MainViewModel : ViewModelBase
    {
        ...
        public XmlDocument GlobalSettingsXmlConfigResourceInstance
        {
            get
            {
                if (_globalSettingsXmlConfigResourceInstance == null)
                {
                    ...
                    using (var ms = new MemoryStream(UniStudio.Community.Properties.Resources.GlobalSettings))
                    {
                        ms.Flush();
                        ms.Position = 0;
        ...
        public DebugSpeed SlowStepSpeed
        {
            ...
            set
            {
                ...
                {
                    case DebugSpeed.Off:
                        SlowStepIcon = "pack://application:,,,/UniStudio.Community;Component/Resource/Image/Ribbon/slow-step-off.png";
                        break;
                    case DebugSpeed.One:
                        SlowStepIcon = "pack://application:,,,/UniStudio.Community;Component/Resource/Image/Ribbon/slow-step-1x.png";
                        break;
                    case DebugSpeed.Two:
                        SlowStepIcon = "pack://application:,,,/UniStudio.Community;Component/Resource/Image/Ribbon/slow-step-2x.png";
                        break;
                    case DebugSpeed.Three:
                        SlowStepIcon = "pack://application:,,,/UniStudio.Community;Component/Resource/Image/Ribbon/slow-step-3x.png";
                        break;
                    case DebugSpeed.Four:
                        SlowStepIcon = "pack://application:,,,/UniStudio.Community;Component/Resource/Image/Ribbon/slow-step-4x.png";
                        break;
                }
            }
        }
        ...
        private string _slowStepIconProperty = "pack://application:,,,/UniStudio.Community;Component/Resource/Image/Ribbon/slow-step-off.png";
        ...
        {
            msg = msg.Replace("\0", "");
            msgDetails = msgDetails.Replace("\0", "");
        ...
        public bool DoCloseProject()
        {
            ...
            ViewModelLocator.instance.Activities.ResetAll();
        ...
        private RelayCommand _closeCurrentDocumentCommand;
        /// <summary>
        /// Gets the CloseCurrentDocumentCommand.
        /// </summary>
        public RelayCommand CloseCurrentDocumentCommand
        {
            get
            {
                return _closeCurrentDocumentCommand
                    ?? (_closeCurrentDocumentCommand = new RelayCommand(
                    () =>
                    {
                        var doc = ViewModelLocator.instance.Dock.ActiveDocument;
                        doc.DoCloseDocument();
