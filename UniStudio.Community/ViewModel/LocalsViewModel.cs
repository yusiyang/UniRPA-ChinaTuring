...
namespace UniStudio.Community.ViewModel
{
    ...
    public class LocalsViewModel : ViewModelBase
    {
        ...
        public LocalsViewModel()
        {
            ...
            Messenger.Default.Register<LocalsModel>(this, "ShowLocals", ShowLocals);
        }
        ...
        private void ShowLocals(LocalsModel localsModel)
        {
            var vars = localsModel.Variables;
            var args = localsModel.Arguments;
            ...
            Common.RunInUI(() =>
            {
                ...
                if (vars!=null)
                {
                    LocalsList.AddRange(vars.Select(t => new LocalsItem
                    {
                        Name = t.Key,
                        Value = t.Value ?? ""
                    }));
                ...
                if (args!=null)
                {
                    LocalsList.AddRange(args.Select(t => new LocalsItem
                    {
                        Name = t.Key,
                        Value = t.Value ?? ""
                    }));
