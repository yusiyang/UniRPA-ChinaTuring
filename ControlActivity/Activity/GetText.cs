...
namespace ControlActivity
{
    ...
    public sealed class GetText : CodeActivity
    {
        ...
        [RequiredArgument]
        [DisplayName("值")]
        [Description("用于在变量中存储指定用户界面元素中的文本，以及使用 VB 表达式修改该文本。在该字段中创建的变量为泛型值类型。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Control/GetText.png";
            }
        }
        ...
        [Browsable(false)]
        public string DefaultName { get { return "获取文本"; } }
