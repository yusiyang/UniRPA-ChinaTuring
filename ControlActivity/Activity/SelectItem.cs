...
namespace ControlActivity
{
    ...
    public sealed class SelectItem : CodeActivity
    {
        ...
        [RequiredArgument]
        [DisplayName("项目")]
        [Description("指定将从下拉框或列表框中选择的项目。必须将文本放入引号中。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Control/SelectItem.png";
            }
        }
        ...
        [Browsable(false)]
        public string DefaultName { get { return "选择项目"; } }
