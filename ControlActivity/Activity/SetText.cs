...
namespace ControlActivity
{
    ...
    public sealed class SetText : CodeActivity
    {
        ...
        [RequiredArgument]
        [DisplayName("文本")]
        [Description("待写入指定用户界面元素的文本。必须将文本放入引号中。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Control/SetText.png";
            }
        }
        ...
        [Browsable(false)]
        public string DefaultName { get { return "设置文本"; } }
