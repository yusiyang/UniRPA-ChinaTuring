...
namespace ControlActivity
{
    ...
    public sealed class SelectMultiItems : CodeActivity
    {
        ...
        [Category("输入")]
        [DisplayName("添加至选择")]
        [Description("指定是否将这些项目添加至现有选择列表中，或者是否首先清除列表框中的选择。")]
        public bool AddToSelection { get; set; }

        [Category("输入")]
        [DisplayName("多项")]
        [Description("指定将从列表框中选择的项目。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Control/SelectMultiItems.png";
            }
        }
        ...
        [Browsable(false)]
        public string DefaultName { get { return "选择多个项目"; } }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                if(element != null)
                {
                    ...
                    element.SelectMultiItems(items);
                }
                else
                {
