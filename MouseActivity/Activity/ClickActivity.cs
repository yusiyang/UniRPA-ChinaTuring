...
namespace MouseActivity
{
    ...
    public sealed class ClickActivity : CodeActivity
    {
        ...
        [Browsable(false)]
        public string DefaultName { get { return "单击"; } }
        ...
        static ClickActivity()
        {
            ...
            builder.AddCustomAttributes(typeof(ClickActivity), "ElementPosition", new EditorAttribute(typeof(ElementPositionTypeEditor), typeof(PropertyValueEditor)));
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                uiElementClickParams.elementPosition = (ElementPosition)ElementPosition;
                ...
                //varDic.Add("Timeout", timeout);
                //varDic.Add("DelayAfter", delayAfter);
                //varDic.Add("DelayBefore", delayBefore);

                //var activityLog = new ActivityLog(DisplayName, "ClickActivity", varDic);
                //var logStr = activityLog.ToString("N;T;P");

                //var flag = ActivityLogFormat.TryParse(logStr, out var activityLog1);

                //SharedObject.Instance.Output(SharedObject.OutputType.Trace, logStr);
