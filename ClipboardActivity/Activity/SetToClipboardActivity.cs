...
namespace ClipboardActivity
{
    ...
    public sealed class SetToClipboardActivity : CodeActivity
    {
        ...
        [RequiredArgument]
        [DisplayName("文本")]
        [Description("要复制到剪贴板的文本。必须将文本放入引号中。")]
        public InArgument<string> Text { get; set; }

        [Category("输入")]
        [DisplayName("是否为文件")]
        [Description("拷贝的目标对象是否为文件，若勾选此选项，则文本属性需要设置为目标文件的全路径。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Clipboard/set-clip-board.png";
            }
        }
