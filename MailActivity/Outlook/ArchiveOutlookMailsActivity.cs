...
namespace MailActivity.Outlook
{
    ...
    public sealed class ArchiveOutlookMailsActivity : CodeActivity
    {
        ...
        [Description("Outlook数据文件的保存路径。必须将文本放入引号中。")]
        public InArgument<string> PstFilePath { get; set; }
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Mail/archive-mail.png";
            }
        }
