...
namespace Plugins.Shared.Library.Attached
{
    public class ActivityDesignerAttached
    {
        ...
        private static void OnIconChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            img_drawing.ImageSource = new BitmapImage(new Uri("pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/"+ newValue));
        ...
        private static void OnResourcesChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            foreach(var item in sArray)
            {
                ...
                {
                    rd = new ResourceDictionary() { Source = new Uri("pack://application:,,,/Plugins.Shared.Library;Component/" + item) };
                }
