...
namespace Plugins.Shared.Library.Librarys
{
    public class Common
    {
        public static void RunInUIAsync(Action func)
        {
        ...
        {
            var dispathcer = System.Windows.Application.Current.Dispatcher;
            if(dispathcer.CheckAccess())
            {
                func();
                return;
            }
        ...
        public static T RunInUI<T>(Func<T> func)
        {
            var dispathcer = System.Windows.Application.Current.Dispatcher;
            if (dispathcer.CheckAccess())
            {
        ...
        public static System.Windows.Window GetOwnerWindow()
        {
