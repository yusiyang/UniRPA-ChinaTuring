...
namespace Plugins.Shared.Library.Librarys
{
    ...
    public class GenericValue : IComparable, IFormattable, IComparable<GenericValue>, IEquatable<GenericValue>, IConvertible
    {
        ...
        {
            if (value is null || value.RawValue == null)
            {
                return false;
            }
        ...
        {
            if((object)lvalue==rvalue)
            {
                return true;
            }
            if (lvalue is object && rvalue is null&&string.IsNullOrEmpty(lvalue.RawValue?.ToString()))
            {
                return true;
            }
            if (lvalue is null && rvalue is object && string.IsNullOrEmpty(rvalue.RawValue?.ToString()))
            {
                return true;
            }
            try
            ...
            return lvalue?.RawValue.Equals(rvalue?.RawValue) ?? false;
        }

        public static bool operator ==(GenericValue lvalue, string rvalue)
        {
            return lvalue == (GenericValue)rvalue;
        }
        ...
        {
            return (GenericValue)lvalue == rvalue;
        }
                    ...
                    case TypeCode.Int64:
                        {
                            ...
                            {
                                result = rawValue + (int)value2;
                                return result;
                            }
                            if (value2.RawValue is decimal)
                            {
                                result = (decimal)rawValue + (decimal)value2;
                                return result;
                            }
                            result = (double)value1.GetRawValue<int>() + (double)value2;
                            return result;
                        }
                    case TypeCode.Double:
                        result = value1.GetRawValue<double>() + (double)value2;
                        return result;
                    case TypeCode.Decimal:
                        result = value1.GetRawValue<decimal>() + (decimal)value2;
                        return result;
                    case TypeCode.DateTime:
                        result = value1.GetRawValue<DateTime>() + (TimeSpan)value2;
                        return result;
        ...
        {
            return value1 + (GenericValue)value2;
        }
            ...
            try
            {
                switch (Type.GetTypeCode(value1.RawValue.GetType()))
                {
                    ...
                    case TypeCode.Int64:
                        {
                            ...
                            if (value2.RawValue is decimal)
                            {
                                result = (decimal)rawValue - value2.GetRawValue<decimal>();
                                return result;
                            }
                            if (value2.RawValue is int)
                            {
                    ...
                    case TypeCode.DateTime:
                        ...
                        result = (GenericValue)value1.GetRawValue<DateTime>() - (TimeSpan)value2;
                        return result;
                }
                throw new Exception();
            }
        ...
        public static int Compare(GenericValue value1, GenericValue value2)
        {
            ...
            if (value1 is null && value2 is object)
            {
                return -1;
            }
            int result;
        ...
        public static string ToString(GenericValue value, string format, IFormatProvider formatProvider)
        {
            ...
            {
                return ((TimeSpan)value).ToString(format, formatProvider);
            }
