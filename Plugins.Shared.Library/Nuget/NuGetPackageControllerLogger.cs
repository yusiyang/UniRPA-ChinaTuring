        ...
        public void _Log(LogLevel level, string message)
        {
            switch(level)
            {
                ...
                case LogLevel.Minimal:
                    //SharedObject.Instance.Output(SharedObject.OutputType.Trace, message);
                    break;
                case LogLevel.Warning:
                    SharedObject.Instance.Output(SharedObject.OutputType.Warning, message);
                    break;
                case LogLevel.Error:
                    SharedObject.Instance.Output(SharedObject.OutputType.Error, message);
                    break;
                default:
                    break;
            }
