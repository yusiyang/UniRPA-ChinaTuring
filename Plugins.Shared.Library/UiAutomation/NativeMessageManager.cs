...
{
    public static class NativeMessageManager
    {
        ...
        /// NativeHost的句柄
        /// </summary>
        public static IntPtr NativeHostHandle => GetHostHandle();

        private static IntPtr CachedHandle;

        public static int ActiveTab => GetActiveTabId();
        ...
        public static int GetActiveTabId()
        {
            ...
            var result = SendNativeMessage(JsonConvert.SerializeObject(message, JsonSetting));
            ...
            if (ret?.RetCode == 1)
            {
                if (int.TryParse(ret.TabId.ToString(), out int tabId))
                {
                    return tabId;
                }
            }
        ...
        /// <returns></returns>
        private static int GetWindowIdForTabId(int tabId)
        {
            var message = new NativeMessage
            {
        ...
        /// 获取位置处的Dom元素
        /// </summary>
        /// <param name="pagRect"></param>
        /// <param name="screenPoint"></param>
        /// <returns></returns>
        private static string GetHtmlFromPoint(Rectangle pagRect, Point screenPoint)
        {
            var message = new NativeMessage
            {
                FunctionCall = nameof(GetHtmlFromPoint),
                PageRenderOfsX = pagRect.X + 8,
                PageRenderOfsY = pagRect.Y + 8,
        ...
        /// <returns></returns>
        public static Rectangle GetHtmlRectangle(Rectangle parentRect, int? tabId, string customId = null)
        {
        ...
        /// <param name="customId"></param>
        /// <returns></returns>
        public static string GetHtmlAttribute(string attrName, int? tabId = null, string customId = null)
        {
            var message = new NativeMessage
            {
        ...
        /// <param name="customId"></param>
        /// <returns></returns>
        public static List<NodeHierarchy> GetHtmlAncestryInfo(int? tabId, string customId = null)
        {
            var message = new NativeMessage
            {
        ...
        /// <returns></returns>
        private static string GetHtmlElemById(int tabId, string processName, string title, Dictionary<string, string> attrDic, string tag, int? index = null)
        {
            var message = new NativeMessage
            {
        ...
        /// <param name="tabId"></param>
        /// <returns></returns>
        public static bool NavigationCommand(string command, int? tabId = null)
        {
            if (tabId < 0)
            {
                return false;
        ...
        /// <param name="tabId"></param>
        /// <returns></returns>
        public static int GetHtmlDevicePixelRatio(int? tabId)
        {
            var message = new NativeMessage
            {
        ...
        /// <param name="customId"></param>
        /// <returns></returns>
        public static string InjectAndRunJs(int? tabId, string jsCode, string input, string customId = null)
        {
            var message = new NativeMessage
            {
        ...
        /// <param name="customId"></param>
        /// <returns></returns>
        public static bool IsHtmlElemValid(int? tabId, string customId)
        {
            var message = new NativeMessage
            {
        ...
        /// <param name="customId"></param>
        /// <returns></returns>
        public static bool ScrollIntoView(int? tabId, string customId)
        {
            var message = new NativeMessage
            {
                FunctionCall = nameof(ScrollIntoView),
                TabId = tabId ?? ActiveTab,
                CustomId = customId
            };
            var result = SendNativeMessage(JsonConvert.SerializeObject(message, JsonSetting));
        ...
        /// <returns></returns>
        public static bool WriteTextHtmlElem(int? tabId, string customId, string text)
        {
            var message = new NativeMessage
            {
        ...
        /// <returns></returns>
        public static bool SetHtmlAttribute(int? tabId, string customId, string attrName, string attrValue)
        {
            var message = new NativeMessage
            {
                FunctionCall = nameof(SetHtmlAttribute),
                TabId = tabId ?? ActiveTab,
                CustomId = customId,
                AttrName = attrName,
                AttrValue = attrValue
        ...
        public static void ClickHtmlElem(int? tabId, string customId)
        {
            var message = new NativeMessage
            {
        ...
        /// <param name="screenPoint"></param>
        /// <returns></returns>
        public static UiNode GetElementFromPoint(UiNode element, Point screenPoint)
        {
            var tabId = GetActiveTabId();
            _currentWindowId = GetWindowIdForTabId(tabId);
            var customId = GetHtmlFromPoint(
                element.BoundingRectangle, screenPoint);

            return new HtmlUiNode(tabId, customId,null);
        }
        /// <summary>
        /// 在页面上查找元素
        /// </summary>
        /// <param name="attrDic"></param>
        /// <returns></returns>
        public static UiNode GetElementFromPath(Dictionary<string, string> attrDic)
        {
            string[] exceptName = { "Name", "AutomationId", "UserDefineId", "ClassName", "Role", "Description", "ProcessName", "Idx", "Index" };
            ...
            customId = GetHtmlElemById(tabId, attrDic["ProcessName"], attrDic["Name"], needAttrDic, attrDic["Role"], int.Parse(attrDic["Index"]));
            if (string.IsNullOrEmpty(customId))
            {
                return null;
            }
            var ids = customId.Split('|');
            return new HtmlUiNode(int.Parse(ids[0]), $"{ids[1]}|{ids[2]}",null);
        }
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public static string GetSameColumn(string id, string input)
        {
            var ids = id.Split('|');
            if (ids.Length < 3)
            {
            ...
            var jsCode = @"function(dummyElem, inputXML) {
    ...
    return outputXml;
            ...
            var tabId = int.Parse(ids[0]);
            var customId = ids[1] + "|" + ids[2];
            var result = InjectAndRunJs(tabId, jsCode, input, customId);
            return result;
        }
        /// <summary>
        /// 获取同列数据
        ...
        /// <returns></returns>
        public static string GetColumnData(string id, string option)
        {
            var ids = id.Split('|');
            if (ids.Length < 3)
            {
            ...
            var jsCode = @"function (topContainer, inputXml)
{
...
";
            var tabId = int.Parse(ids[0]);
            var customId = ids[1] + "|" + ids[2];
            var result = InjectAndRunJs(tabId, jsCode, option, customId);
            return result;
        }
        /// <summary>
        /// 同列元素染色
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public static bool ColorColumn(string id, string input)
        {
            var ids = id.Split('|');
            if (ids.Length < 3)
            {
            ...
            var jsCode = @"function(dummyElem, colName) {
    // For frame/iframe scenario we need to get the parent document of parameter dummyElem.
    // In Chrome/Firefox, the document refers to top document; for IE it should be already set to iframe/frame document.
    var htmlDoc = document;
    if (dummyElem && dummyElem.ownerDocument) {
    ...
    for (var i = 0; i < all.length; ++i) {
        ...
        if (e.getAttribute(""data-extract-result-name"", 0) === colName) {
            ...
            var tabId = int.Parse(ids[0]);
            var customId = ids[1] + "|" + ids[2];
            InjectAndRunJs(tabId, jsCode, input, customId);
            return true;
        }
        /// <summary>
        /// 预览页、配置页返回时调用
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static bool StepTo(string id)
        {
            var ids = id.Split('|');
            if (ids.Length < 3)
            {
    ...
    for (var i = 0; i < all.length; ++i) {
        ...
        if (e.getAttribute(""data-extract-result-name"", 0)) {
            ...
            var tabId = int.Parse(ids[0]);
            var customId = ids[1] + "|" + ids[2];
            InjectAndRunJs(tabId, jsCode, "", customId);
            return true;
        }
        #endregion
        ...
        private static IntPtr GetBrowserHandle()
        {
            var msg = new NativeMessage
            {
                FunctionCall = nameof(GetBrowserHandle)
            };
            var result = SendNativeMessage(JsonConvert.SerializeObject(msg, JsonSetting));
            if (string.IsNullOrEmpty(result))
            {
                CachedHandle = IntPtr.Zero;
                return IntPtr.Zero;
            }
            return CachedHandle = (IntPtr)int.Parse(result);
        }
        ...
        /// <returns>插件返回结果</returns>
        private static string SendNativeMessage(string message)
        {
            var result = "";
            try
            {
                using (var pipeClient = new NamedPipeClientStream("localhost", "NativeHost-Chrome", PipeDirection.InOut, PipeOptions.None, TokenImpersonationLevel.None))
                {
                    pipeClient.Connect(1000);//连接服务端
        ...
        public static void CloseBrowser(int? tabId = null)
        {
            var message = new NativeMessage
            {
                FunctionCall = nameof(CloseBrowser),
                TabId = tabId ?? ActiveTab
            };
            var result = SendNativeMessage(JsonConvert.SerializeObject(message, JsonSetting));
            //var ret = JsonConvert.DeserializeObject<NativeMessage>(result);
            //if (ret?.RetCode == 1)
            //{
            //    int.TryParse(ret.TabId.ToString(), out CurrentTabId);
            //}
            //return CurrentTabId;
        }

        public static void Navigate(string url, int? tabId = null)
        {
            var message = new NativeMessage
            {
