...
namespace UniUpdater.Libraries
{
    public class ZipHelper
    {
        ...
        public static void UnZip(string zipFilePath, string unZipDir=null,Action<string,double> notifyProgress=null)
        {
                ...
                while ((theEntry = s.GetNextEntry()) != null)
                {
                    ...
                    if (theEntry.IsFile)
                    {
                        ...
                        if (notifyProgress != null)
                        {
                            ...
                            notifyProgress.Invoke(theEntry.Name,totalSize * 1.0 / fileInfo.Length);
                        }
                    }
                }
            }
