...
namespace ApplicationActivity
{
    ...
    public sealed class GetProcessActivity : CodeActivity
    {
        ...
        [Category("输出")]
        [DisplayName("进程集合")]
        [Description("进程对象的集合，表示当前 Windows 会话中正在运行的进程。")]
        ...
        public string icoPath
        {
            get
            {
                return @"pack://application:,,,/Plugins.Shared.Library;Component/Resource/Image/Activities/Application/get-process.png";
            }
        }
